...
class SHOOTTOKILL_API UDealDamageComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION()
	void OnOverlapBegin(class UPrimitiveComponent* OverlappingComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& Sweep);
